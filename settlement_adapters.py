...
_REGISTRY_ROWS = [
    ...
    ("카카오", "merged_header_single_table", "wide_header_policy_gate", "정산리포트_카카오페이지_*, 정산 상세 리포트", "미발행/선투자 파일은 중복 검토", "플랫폼 작품명 / 시리즈명", "작가명", "플랫폼작품ID / 시리즈ID / 제품코드", "총합계-원화 / 공급대가 / 총합계-순매출", "공급가액", "세액은 별도 보존. 상계 아님", "needs_tax_policy", "과/면세 및 공급가액/공급대가 기준 확정 전 출력 금지"),
